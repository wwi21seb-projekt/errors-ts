...
export const InvalidCredentials = new CustomError("The credentials are invalid. Please check the credentials and try again.", "ERR-008", 401);
...
export const Unauthorized = new CustomError("The request is unauthorized. Please login to your account.", "ERR-014", 401);
...
export const SubscriptionSelfFollow = new CustomError("You cannot follow yourself. Please check the username and try again.", "ERR-017", 400);
