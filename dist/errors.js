...
export const InvalidCredentials = new CustomError("The credentials are invalid. Please check the credentials and try again.", "ERR-008", 403);
...
export const UserAlreadyActivated = new CustomError("The user is already activated. Please login to your account.", "ERR-013", 208);
